...
List<UserRankList?> UserRankingList(String str) => List<UserRankList?>.from(
    jsonDecode(str)!.map((x) => UserRankList.fromJson(x)));

String User_registerToJson(List<UserRankList> data) =>
...
class UserRankList {
  ...
  UserRankList.fromJson(Map<String, dynamic> json) {
...
class Domestic {
  ...
  Domestic({this.id, this.name, this.email, this.target});
...
class Distributors {
  ...
  Distributors({this.id, this.name, this.email, this.target});
...
class Technician {
  ...
  Technician({this.id, this.name, this.email, this.target});
...
class Investors {
  ...
  Investors({this.id, this.name, this.email, this.target});
...
class Bpartner {
  ...
  Bpartner({this.id, this.name, this.email, this.target});

  Bpartner.fromJson(Map<String, dynamic> json) {
    this.id = json["id"];
    this.name = json["name"];
    this.email = json["email"];
    this.target = json["target"];
...
class Advisors {
  ...
  Advisors({this.id, this.name, this.email, this.target});
